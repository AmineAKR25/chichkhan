...
function footerBlocks(venue) {
  ...
  return `<div class="footer-top"><div class="footer-column footer-identity"><a class="footer-brand" href="/${escape(venue.slug)}">${escape(venue.name)}</a><p>Prix en dinars tunisiens (DT)</p></div>${column("Nous trouver", find)}${column("Nous suivre", follow)}${column("Votre avis", review)}</div>`;
}
