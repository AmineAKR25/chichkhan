> Current scope (13 September 2026): Chichkhan is now the root application. The independent `/restaurant` and `/cafe` routes, supplied hero photograph and category placeholders are preserved. The earlier brief below is historical; its homepage and placeholder-only hero directions were superseded by the independent-routes addendum in DESIGN_REVIEW.md.
